...
interface AddEditBoardModal {
	setIsBoardModalOpen: any;
	type: string;
}

function AddEditBoardModal({ setIsBoardModalOpen, type }: AddEditBoardModal) {
	...
	if (type === 'edit' && isFirstLoad) {
		setNewColumns(
			board?.columns.map((col: ColumnKanban) => {
	...
	const onChange = (id: Id, newValue: string) => {
