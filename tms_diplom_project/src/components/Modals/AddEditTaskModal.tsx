...
interface AddEditTaskModal {
	type: string;
	device: string;
	setIsTaskModalOpen: any;
	setIsAddTaskModalOpen: any;
...
function AddEditTaskModal({
	...
	const col = columns?.find(
		(col: ColumnKanban, index: number) => index === prevColIndex
	);
	const task: TaskKanban = col
		? col.tasks.find((task: TaskKanban, index: number) => index === taskIndex)
		: [];
	...
	const onChangeSubtasks = (id: number | string, newValue: number | string) => {
