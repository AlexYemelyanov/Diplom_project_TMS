...
interface Sidebar {
	...
	setIsSideBarOpen: (arg0: unknown) => void;
}

function Sidebar({ isSideBarOpen, setIsSideBarOpen }: Sidebar) {
	...
	const toggleSidebar = () => {
		setIsSideBarOpen((curr: unknown) => !curr);
	};
	...
	return (
		<div>
			<div
				className={
					isSideBarOpen
						? `min-w-[221px] bg-[var(--column-bg)]  fixed top-[72px] h-screen  items-center left-0 z-20`
